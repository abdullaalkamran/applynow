...
import { Search, Plus, Globe2, GraduationCap, ChevronRight } from "lucide-react";
  ...
  return (
    <div>
      <PageHeader
        ...
        action={<Button onClick={() => navigate("/staff/data/universities/new")}><Plus size={15} /> Add University</Button>}
      />
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
        {countries.map((c) => (
          <button
            ...
            className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white p-4 text-left hover:border-slate-300"
          >
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="shrink-0 rounded-full bg-slate-100 px-1.5 py-0.5 font-mono text-[10px] font-semibold text-slate-400">{getCountryId(c.country)}</span>
                </div>
