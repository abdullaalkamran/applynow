...
export const UNIVERSITIES: University[] = [
  {
    ...
    requirements: ["Bachelor's degree, 2:1 or equivalent", "Statement of purpose", "Two academic references"],
    ...
    minimumDepositAmount: 2650,
    paymentDeadline: "2026-07-01",
    depositRules: ["Due within 14 days of accepting the offer", "Non-refundable if the visa application is refused after CAS/CoE issuance", "Deducted from the first semester's tuition fee"],
    currencySymbol: "£",
    minIELTS: 6.5,
    minGPA: 3.3,
    englishRequirements: [{ testName: "IELTS", minScore: "6.5", skillScores: [{ skill: "Listening", score: "6.0" }, { skill: "Reading", score: "6.0" }, { skill: "Writing", score: "6.0" }, { skill: "Speaking", score: "6.0" }] }, { testName: "TOEFL iBT", minScore: "90", skillScores: [{ skill: "Listening", score: "90" }, { skill: "Reading", score: "90" }, { skill: "Writing", score: "90" }, { skill: "Speaking", score: "90" }] }, { testName: "PTE Academic", minScore: "58", skillScores: [{ skill: "Listening", score: "58" }, { skill: "Reading", score: "58" }, { skill: "Writing", score: "58" }, { skill: "Speaking", score: "58" }] }, { testName: "Duolingo English Test", minScore: "110", skillScores: [{ skill: "Listening", score: "110" }, { skill: "Reading", score: "110" }, { skill: "Writing", score: "110" }, { skill: "Speaking", score: "110" }] }],
    accreditations: ["Russell Group"],
    scholarshipsAvailable: true,
    openIntake: "September 2026",
    intakeDates: {"September": { applicationDeadline: "2026-06-01", casRequestDeadline: "2026-08-01", enrollmentDate: "2026-09-05" }, "January": { applicationDeadline: "2026-10-01", casRequestDeadline: "2026-12-01", enrollmentDate: "2027-01-05" }},
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, 2:1 or equivalent", "Statement of purpose"],
    ...
    minIELTS: 7.0,
    minGPA: 3.3,
    englishRequirements: [{ testName: "IELTS", minScore: "7.0", skillScores: [{ skill: "Listening", score: "6.5" }, { skill: "Reading", score: "6.5" }, { skill: "Writing", score: "6.5" }, { skill: "Speaking", score: "6.5" }] }, { testName: "TOEFL iBT", minScore: "100", skillScores: [{ skill: "Listening", score: "100" }, { skill: "Reading", score: "100" }, { skill: "Writing", score: "100" }, { skill: "Speaking", score: "100" }] }, { testName: "PTE Academic", minScore: "65", skillScores: [{ skill: "Listening", score: "65" }, { skill: "Reading", score: "65" }, { skill: "Writing", score: "65" }, { skill: "Speaking", score: "65" }] }, { testName: "Duolingo English Test", minScore: "120", skillScores: [{ skill: "Listening", score: "120" }, { skill: "Reading", score: "120" }, { skill: "Writing", score: "120" }, { skill: "Speaking", score: "120" }] }],
    accreditations: ["Russell Group"],
    scholarshipsAvailable: true,
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, 2:1 or equivalent", "Portfolio (for some courses)"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, 2:2 or equivalent", "Statement of purpose"],
    ...
    minimumDepositAmount: 2500,
    paymentDeadline: "2026-07-01",
    depositRules: ["Due within 14 days of accepting the offer", "Non-refundable if the visa application is refused after CAS/CoE issuance", "Deducted from the first semester's tuition fee"],
    currencySymbol: "£",
    minIELTS: 6.0,
    minGPA: 3.0,
    englishRequirements: [{ testName: "IELTS", minScore: "6.0", skillScores: [{ skill: "Listening", score: "5.5" }, { skill: "Reading", score: "5.5" }, { skill: "Writing", score: "5.5" }, { skill: "Speaking", score: "5.5" }] }, { testName: "TOEFL iBT", minScore: "80", skillScores: [{ skill: "Listening", score: "80" }, { skill: "Reading", score: "80" }, { skill: "Writing", score: "80" }, { skill: "Speaking", score: "80" }] }, { testName: "PTE Academic", minScore: "50", skillScores: [{ skill: "Listening", score: "50" }, { skill: "Reading", score: "50" }, { skill: "Writing", score: "50" }, { skill: "Speaking", score: "50" }] }, { testName: "Duolingo English Test", minScore: "95", skillScores: [{ skill: "Listening", score: "95" }, { skill: "Reading", score: "95" }, { skill: "Writing", score: "95" }, { skill: "Speaking", score: "95" }] }],
    accreditations: ["Russell Group"],
    scholarshipsAvailable: true,
    openIntake: "September 2026",
    intakeDates: {"September": { applicationDeadline: "2026-06-01", casRequestDeadline: "2026-08-01", enrollmentDate: "2026-09-05" }, "January": { applicationDeadline: "2026-10-01", casRequestDeadline: "2026-12-01", enrollmentDate: "2027-01-05" }},
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, GPA 3.0+", "Statement of purpose", "Two academic references"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, GPA 3.2+", "Statement of purpose", "Portfolio (for some programs)"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, B+ average or equivalent", "Statement of purpose"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, B average or equivalent", "Statement of purpose", "Two academic references"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, distinction average or equivalent", "Statement of purpose"],
    ...
    intakeDates: {"February": { applicationDeadline: "2026-11-01", casRequestDeadline: "2027-01-01", enrollmentDate: "2027-02-05" }, "July": { applicationDeadline: "2027-04-01", casRequestDeadline: "2027-06-01", enrollmentDate: "2027-07-05" }},
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree, credit average or equivalent", "Portfolio (for some programs)"],
  ...
  },
  {
    ...
    requirements: ["Bachelor's degree in a related field", "Statement of purpose", "Relevant coursework transcript"],
    ...
    intakeDates: {"October": { applicationDeadline: "2026-07-01", casRequestDeadline: "2026-09-01", enrollmentDate: "2026-10-05" }, "April": { applicationDeadline: "2027-01-01", casRequestDeadline: "2027-03-01", enrollmentDate: "2027-04-05" }},
    website: "tum.de",
    tone: "rose",
  },
  {
    ...
    requirements: ["Bachelor's degree, GPA 3.0+", "Statement of purpose"],
