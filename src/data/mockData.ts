...
export const APPLICATIONS: Application[] = [
  ...
  {
    // Referred by an agent, submitted before being claimed by a specific counsellor — still needs
    // to show up on the counsellor's Applications page.
    id: "app7", studentId: "s9", university: "University of Birmingham", course: "MSc Mechanical Engineering",
    intake: "Sep 2027", country: "UK", status: "Submitted", progress: 15, nextAction: "Awaiting university confirmation of receipt",
    waitingOn: "university", stages: stages(2), updatedAt: "2026-09-09", source: "counsellor",
  },
  {
    id: "app8", studentId: "s10", university: "University of Edinburgh", course: "MSc Artificial Intelligence",
    intake: "Sep 2027", country: "UK", status: "Documents Pending", progress: 32, nextAction: "Upload English test score",
    waitingOn: "student", stages: stages(1), updatedAt: "2026-09-07", source: "student",
  },
];
...
export const UNIVERSITIES: University[] = [
  {
    ...
    courses: [
      { id: "crs1", name: "MSc Data Science", level: "Postgraduate", duration: "1 year", subject: "Data Science & AI", feeUSD: 35000 },
      { id: "crs2", name: "MSc Computer Science", level: "Postgraduate", duration: "1 year", subject: "Computer Science & IT", feeUSD: 33500 },
      { id: "crs3", name: "BSc Economics", level: "Undergraduate", duration: "3 years", subject: "Social Sciences", feeUSD: 24500 },
    ],
    ...
    minIELTS: 6.5,
    minGPA: 3.3,
    englishRequirements: [{ testName: "IELTS", minScore: "6.5", minBand: "6.0", skillScores: [{ skill: "Listening", score: "6.0" }, { skill: "Reading", score: "6.0" }, { skill: "Writing", score: "6.0" }, { skill: "Speaking", score: "6.0" }] }, { testName: "TOEFL iBT", minScore: "90", minBand: "80" }, { testName: "PTE Academic", minScore: "58", minBand: "50" }, { testName: "Duolingo English Test", minScore: "110", minBand: "95" }],
  ...
  },
  {
    ...
    courses: [
      { id: "crs4", name: "MSc International Management", level: "Postgraduate", duration: "1 year", subject: "Business & Management", feeUSD: 39000 },
      { id: "crs5", name: "LLM Law", level: "Postgraduate", duration: "1 year", subject: "Law", feeUSD: 40500 },
    ],
    ...
    minIELTS: 7.0,
    minGPA: 3.3,
    englishRequirements: [{ testName: "IELTS", minScore: "7.0", minBand: "6.5", skillScores: [{ skill: "Listening", score: "6.5" }, { skill: "Reading", score: "6.5" }, { skill: "Writing", score: "6.5" }, { skill: "Speaking", score: "6.5" }] }, { testName: "TOEFL iBT", minScore: "100", minBand: "90" }, { testName: "PTE Academic", minScore: "65", minBand: "58" }, { testName: "Duolingo English Test", minScore: "120", minBand: "110" }],
    accreditations: ["Russell Group"],
    scholarshipsAvailable: true,
  ...
  },
  {
    ...
    courses: [
      { id: "crs6", name: "MSc Artificial Intelligence", level: "Postgraduate", duration: "1 year", subject: "Data Science & AI", feeUSD: 36000 },
      { id: "crs7", name: "BEng Mechanical Engineering", level: "Undergraduate", duration: "4 years", subject: "Engineering", feeUSD: 26000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs8", name: "MSc Business Analytics", level: "Postgraduate", duration: "1 year", subject: "Business & Management", feeUSD: 33000 },
      { id: "crs9", name: "BSc Computer Science", level: "Undergraduate", duration: "3 years", subject: "Computer Science & IT", feeUSD: 23000 },
    ],
    ...
    minIELTS: 6.0,
    minGPA: 3.0,
    englishRequirements: [{ testName: "IELTS", minScore: "6.0", minBand: "5.5", skillScores: [{ skill: "Listening", score: "5.5" }, { skill: "Reading", score: "5.5" }, { skill: "Writing", score: "5.5" }, { skill: "Speaking", score: "5.5" }] }, { testName: "TOEFL iBT", minScore: "80", minBand: "71" }, { testName: "PTE Academic", minScore: "50", minBand: "42" }, { testName: "Duolingo English Test", minScore: "95", minBand: "85" }],
    accreditations: ["Russell Group"],
    scholarshipsAvailable: true,
    openIntake: "September 2026",
  ...
  },
  {
    ...
    courses: [
      { id: "crs10", name: "MS Business Analytics", level: "Postgraduate", duration: "1.5 years", subject: "Business & Management", feeUSD: 60000 },
      { id: "crs11", name: "BA Economics", level: "Undergraduate", duration: "4 years", subject: "Social Sciences", feeUSD: 54000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs12", name: "MS Computer Science", level: "Postgraduate", duration: "1.5 years", subject: "Computer Science & IT", feeUSD: 66000 },
      { id: "crs13", name: "BA Communication", level: "Undergraduate", duration: "4 years", subject: "Arts & Humanities", feeUSD: 60000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs14", name: "MEng Computer Engineering", level: "Postgraduate", duration: "1.5 years", subject: "Engineering", feeUSD: 35000 },
      { id: "crs15", name: "BSc Computer Science", level: "Undergraduate", duration: "4 years", subject: "Computer Science & IT", feeUSD: 29000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs16", name: "MA Political Science", level: "Postgraduate", duration: "2 years", subject: "Arts & Humanities", feeUSD: 31000 },
      { id: "crs17", name: "BSc Biology", level: "Undergraduate", duration: "3 years", subject: "Medicine & Health Sciences", feeUSD: 26000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs18", name: "Master of Data Science", level: "Postgraduate", duration: "2 years", subject: "Data Science & AI", feeUSD: 31000 },
      { id: "crs19", name: "Bachelor of Commerce", level: "Undergraduate", duration: "3 years", subject: "Business & Management", feeUSD: 25000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs20", name: "Master of Engineering", level: "Postgraduate", duration: "2 years", subject: "Engineering", feeUSD: 32500 },
      { id: "crs21", name: "Bachelor of Architecture", level: "Undergraduate", duration: "5 years", subject: "Architecture", feeUSD: 27000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs22", name: "MSc Business Analytics", level: "Postgraduate", duration: "1 year", subject: "Business & Management", feeUSD: 27500 },
      { id: "crs23", name: "BA English Studies", level: "Undergraduate", duration: "4 years", subject: "Arts & Humanities", feeUSD: 21000 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs24", name: "MSc Data Engineering & Analytics", level: "Postgraduate", duration: "2 years", subject: "Data Science & AI", feeUSD: 3200 },
      { id: "crs25", name: "BSc Mechanical Engineering", level: "Undergraduate", duration: "3 years", subject: "Engineering", feeUSD: 2800 },
    ],
  ...
  },
  {
    ...
    courses: [
      { id: "crs26", name: "MBA", level: "Postgraduate", duration: "2 years", subject: "Business & Management", feeUSD: 24000 },
      { id: "crs27", name: "BSc Architecture", level: "Undergraduate", duration: "5 years", subject: "Architecture", feeUSD: 21000 },
    ],
